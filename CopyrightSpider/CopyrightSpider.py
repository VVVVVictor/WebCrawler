...
title = [u'登记号', u'分类号', u'软件全称', u'软件简称', u'版本号', u'著作权人（国籍）', u'首次发表日期', u'登记日期']
...
def getDataByKw(keyword, writer):
    ...
    while True:
        ...
        data = {'method':'list', 'no':'fck', 'sql_name':'', 'sql_regnum':'', 'sql_author':newkw, 'curPage':str(pageNow), 'count':'80', 'sortOrder':'', 'sortLabel':''}
        ...
        req = urllib2.Request(requestUrl, headers=getRandomHeaders())
        try:
