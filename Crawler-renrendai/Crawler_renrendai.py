...
titles = ([u'抓取日期', u'抓取时间', u'序号', u'类型', u'认证或担保机构', u'标题', u'总额（元）', u'利率(%)', u'还款期限（月）', u'状态', u'保障方式', u'提前还款率(%)', u'还款方式', u'月还本息', u'投标进度(%)', u'满标用时', u'用户ID', u'用户名', u'性别', u'年龄', u'学历', u'学校', u'婚姻', u'公司行业', u'公司规模', u'岗位职责', u'工作城市', u'工作时间', u'收入范围', u'房产', u'房贷', u'车产', u'车贷', u'工作类型', u'信用等级', u'申请借款（笔）', u'成功还款（笔）', u'还清笔数（笔）', u'信用额度', u'借款总额', u'待还本息（元）', u'逾期金额（元）', u'逾期次数（次）', u'严重逾期', u'信用报告', u'信用报告通过日期', u'身份认证', u'身份认证通过日期', u'工作认证', u'工作认证通过日期', u'收入认证', u'收入认证通过日期', u'房产认证', u'房产认证通过日期', u'购车认证', u'购车认证通过日期', u'结婚认证', u'结婚认证通过日期', u'学历认证', u'学历认证通过日期', u'技术职称认证', u'技术职称认证通过日期', u'手机认证', u'手机认证通过日期', u'微博认证', u'微博认证通过日期', u'居住地证明', u'居住地证明通过日期', u'视频认证', u'视频认证通过日期', u'借款描述'], [u'抓取日期', u'抓取时间', u'序号', u'投标人ID', u'投标人昵称', u'投标金额', u'投标日期', u'投标时间', u'是否理财计划自动投标', u'理财计划期数'], [u'抓取日期', u'抓取时间', u'序号', u'合约还款日期', u'状态', u'应还本息', u'应付罚息', u'实际还款日期'], [u'抓取日期', u'抓取时间', u'序号', u'债权人ID', u'债权人昵称', u'待收本金（元）', u'持有份数（份）', u'是否理财计划自动投标', u'理财计划期数'], [u'抓取日期', u'抓取时间', u'序号', u'债权买入者昵称', u'债权买入者ID', u'债权卖出者昵称', u'债权卖出者ID', u'理财计划期数', u'交易金额', u'交易份数', u'交易日期', u'交易时间'], [u'抓取日期', u'抓取时间', u'发标人ID', u'发标人昵称', u'注册时间', u'持有债权数量（笔）', u'持有理财计划数量（笔）', u'发布借款数量', u'成功借款数量（笔）', u'未还清借款数量', u'逾期次数', u'逾期金额', u'严重逾期笔数'], [u'抓取日期', u'抓取时间', u'序号', u'留言者ID', u'留言者昵称', u'留言日期', u'留言时间', u'留言内容'], [u'抓取日期', u'抓取时间', u'序号', u'催收时间', u'联系人', u'描述'])
...
if __name__=='__main__':
    ...
    print '*******************************'
    print '* Renrendai Loan Spider v0901 *'
    print '*******************************'
    config = getConfig()
