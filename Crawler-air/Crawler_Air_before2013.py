...
if __name__ == '__main__':
    ...
    print '*******************************************'
    print '* Air dairy Spider Before 2013/12/30 v1015*'
    print '*******************************************'
    
    while True:
        try:
            raw_start = raw_input(u'start date(20000101~20131230):')
            i_startDate = int(raw_start)
            if i_startDate < 20000101 or i_startDate > 20131230:
                print('Start date must be after 20000101 and before 20131230.')
                continue;
            break
        except:
    ...
    while True:
        try:
            raw_end = raw_input(u'end date(20000101~20131230):')
            i_endDate = int(raw_end);
            if i_endDate < i_startDate or i_endDate > 20131230:
                print('End date must be after start date and before 20131230.');
                continue;
            break
        except:
            print('Illegal date. Input again!')
